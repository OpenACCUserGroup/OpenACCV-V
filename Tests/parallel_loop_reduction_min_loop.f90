      INTEGER FUNCTION test()
        ...
        !$acc data copyin(a(1:10*LOOPCOUNT), b(1:10*LOOPCOUNT)) copy(c(1:10*LOOPCOUNT), minimum(1:10))
...
!      READ  (*,*) logfilename
      ...
      WRITE (*,*) "--------------------------------------------------"
      WRITE (*,*) "Test of parallel_loop_reduction_min_loop"
      WRITE (*,*) "--------------------------------------------------"

      crossfailed=0
      result=1
      WRITE (1,*) "--------------------------------------------------"
      WRITE (1,*) "Test of parallel_loop_reduction_min_loop"
      WRITE (1,*) "--------------------------------------------------"
      WRITE (1,*)
