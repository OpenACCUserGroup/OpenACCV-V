      INTEGER FUNCTION test()
        ...
        !$acc data copyin(a(1:LOOPCOUNT), b(1:LOOPCOUNT), d(1:LOOPCOUNT), &
        !$acc e(1:LOOPCOUNT)) copy(c(1:LOOPCOUNT), f(1:LOOPCOUNT), &
        !$acc g(1:LOOPCOUNT))
...
!      READ  (*,*) logfilename
      ...
      WRITE (*,*) "--------------------------------------------------"
      WRITE (*,*) "Test of parallel_async"
      WRITE (*,*) "--------------------------------------------------"

      crossfailed=0
      result=1
      WRITE (1,*) "--------------------------------------------------"
      WRITE (1,*) "Test of parallel_async"
      WRITE (1,*) "--------------------------------------------------"
      WRITE (1,*)
